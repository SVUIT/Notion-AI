...
def main(context):
    try:
        ...
        if not task_description:
            ...
            return context.res.json({"status": "skipped", "reason": "missing task description"})
        ...
        try:
            ...
            return context.res.json({"status": "error", "message": "Failed to update database"})

        return context.res.json({"status": "success", "ai_response": ai_response})
